 ...
 * (quét QR momo/vietqr/chuyển khoản, không có ảnh chụp màn hình do khách gửi) — dùng làm
...
{
    /**
     * @param  array{r:int,g:int,b:int}  $color  Màu thương hiệu (momo/vietqr/ngân hàng...)
