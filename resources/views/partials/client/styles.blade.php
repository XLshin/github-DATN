<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets-client/images/favicon.svg') }}">

<link rel="stylesheet" href="{{ asset('assets-client/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/vendors/bootstrap-icons/bootstrap-icons.css') }}">
<link rel="stylesheet" href="{{ asset('assets-client/css/LineIcons.3.0.css') }}">
