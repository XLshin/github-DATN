{{-- Hóa đơn điện tử — hiện ngay khi hệ thống phát hiện giao dịch đã được thanh toán, phỏng theo
    đúng màn hình "Giao dịch thành công" của từng phương thức (VietQR xanh dương, ngân hàng kiểu
    TPBank/VCB Digibank nền tối) để trông giống thật thay vì một khuôn dùng chung. --}}
@php
...
<div class="modal fade" id="receiptModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" style="max-width:340px">
        ...
        @else
        {{-- Khung ngân hàng: nền tối kiểu TPBank/VCB Digibank --}}
        @php
            $brandColor = '#007A4D';
        @endphp
