...
.topbar-link { color: rgba(255,255,255,.85); text-decoration: none; font-size: 12.5px; transition: color .2s; }
.topbar-link:hover { color: #fdd835; }
...
.header-search-wrap { flex-grow: 1; max-width: 620px; }
.search-wrap input {
    flex: 1;
    border: none;
...
.account-btn:hover { background: #1565c0; color: #fff; }
.account-menu {
    display: none;
    position: absolute;
    right: 0;
